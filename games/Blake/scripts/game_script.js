...
function startGame() {
    ...
    wall = new component ( -608, 255, "#8B8000" , 1350 ,0)
    wall2 = new component ( 603, 255, "#8B8000" , 0 ,0)
    wall3 = new component ( 603, -255, "#8B8000" , 0 ,650)
    wall4 = new component ( -608, -245, "#8B8000" , 1350 ,650)
}
//drawling
var myGameArea = {
...
function component(width, height, color, x, y) {
    ...
    this.update = function() {
        ...
        //bottom right wall
        if(myGamePiece.y > 378 && myGamePiece.x > 720){
            console.log("Edge");
